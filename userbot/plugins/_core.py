...
DELETE_TIMEOUT = 3
thumb_image_path = "./Resources/BLACK GHOULS.jpg"
...
async def unload(event):
    ...
    try:
        ...
        qwe = await eor(event, f"BLACK-GHOULS Has Successfully unloaded {shortname}")
    except Exception as e:
        await qwe.edit(
            "BLACK-GHOULS has Successfully unloaded {shortname}\n{}".format(shortname, str(e))
        )
...
async def load(event):
    ...
    try:
        ...
        qwe = await eor(event, f"BLACK-GHOULS Successfully loaded {shortname}")
    except Exception as e:
        await qwe.edit(
            f"BLACK-GHOULS could not load {shortname} because of the following error.\n{str(e)}"
        )
